...
export default function CountryTable({ countries }: TableProps) {
  ...
  //
  // Empty and loading states could be handled here if needed
  //
  if (!countries.length) {
    return <Loading />;
  }
  ...
  if (!filteredCountries.length) {
    return <EmptyState message="No countries match the selected filters." />;
  }
  //
  // RENDER
  //
  return (
    <>
      ...
      <SearchBar value={searchTerm} onChange={(term) => setSearchTerm(term)} />
